...
const ProductDetails = () => {
  ...
  /* ── Buy Now (skip cart, go straight to checkout) ── */
    ...
    try {
      ...
      const items = [{ productId: data, quantity: 1 }]
      navigate('/user/dashboard/address', { state: { total: getDiscounted(), items } })
    } catch (err) {
      setCartMsg('Something went wrong. Try again.')
    } finally {
      setAdding(false)
  ...
  const catName =
    typeof data.category === "object" ? data.category?.category : data.category;
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-7">
              ...
              {cartMsg && (
                <div
                  style={{
                    background: cartMsg.includes("wrong")
                      ? "rgba(220,53,69,.1)"
                      : "rgba(40,167,69,.1)",
