...
const Users = () => {
  ...
  const handleDelete = async (id, name) => {
    if (
      !window.confirm(
        `Are you sure you want to permanently delete user "${name}"? This action is irreversible.`,
      )
    ) {
      return;
    }
      ...
      <div className="dash-page-header">
        <div>
          ...
          <p className="dash-page-subtitle">
            View, search, and manage registered store customer accounts
          </p>
        </div>
        <button className="dash-btn-outline" onClick={fetchUsers}>
          🔄 Refresh Directory
        </button>
      </div>
